    ...
    if r == 1
        switch( options.method )
          case {'std_multiclass_basic_architecture',...
            ...
            return
          case {'unimodal_basic_architecture','unimodal_sophisticated_architecture',...
                'unimodal_basic_architecture_special','unimodal_basic_architecture_other'}
            return
          case 'binary'
            return
          otherwise
            warning('wrong method. using by default standard multiclass')
            options.method = 'std_multiclass_basic_architecture';
        end
    else
        options.method = 'std_multiclass_basic_architecture';
    end
